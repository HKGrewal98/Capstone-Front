...
export const Financials = () => {
   ...
   <div className='Adddocument'>
    ...
    <table className="table customTableMArgin">
      ...
      <tbody>
        ...
        {FinancialsData.reports.slice((arrayPageState-1)*4,arrayPageState* 4).map((data)=>{
          return(
            
              <tr key={data?.file_id}>
          <th >{data?.report_created_at.slice(0,10)}</th>
  ...
  <path d="M8.58301 11.7917L17.7497 2.625" stroke="#007D99" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    {FinancialsData?.reports?.length>4 ? <div className='d-flex justify-content-center'>
